...
function sayHelloStyleChange(event){
    sayHelloButton.style.backgroundColor = "black"
    sayHelloButton.style.color = "white"
}
sayHelloButton.addEventListener("mouseover", sayHelloStyleChange)
...
function sayHelloStyleChangeBack(event){
    sayHelloButton.style.backgroundColor = "white"
    sayHelloButton.style.color = "black"
}
sayHelloButton.addEventListener("mouseout", sayHelloStyleChangeBack)
...
const queryTest = () => {
    axios.get(`http://localhost:3000/query-test/?Number=50`)
    .then((res) => {
        console.log(res.data)
    })
}
...
// let myQuery = document.getElementById("query-button").value
